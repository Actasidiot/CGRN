...
parser.add_argument('--test_obj', dest='test_obj', type=str, required=False, help='the images for testing')
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        model = CGRN(batch_size=args.batch_size, fontclass_num = args.fontclass_num, charclass_num = args.charclass_num,  use_bn = args.use_bn)
